...
(function($){
	...
	$("div[data-scro='controler'] b,div[data-scro='controler2'] a").click(function(){
		...
		J2ROLLING_ANIMATION.st({
			findObject : T,	//µ±Ç°µã»÷¶ÔÏó Ä¬ÈÏÐ´
			main : T.parent().parent().find("div[data-scro='list']"),	//¹ö¶¯Ä¿±êÈÝÆ÷´°¿Ú¶ÔÏó
			pagSource : T.parent().parent().find("div[data-scro='controler'] b"),	//ÇÐ»»°´Å¥¶ÔÏó
			className : "down",		//Ñ¡ÖÐµÄÑùÊ½
			duration : "slow",		//¹ö¶¯ËÙ¶È ºÍjqueryËÙ¶ÈÒ»ÖÂ
			on : $(this)[0].tagName=="A" ? true : false		//ÓÃÓÚÅÐ¶ÏÊÇ·ñ¿ªÆôÎÞÏÞ¹ö¶¯ or À´»ØÇÐ»»
		});
		return false;
	});
	...
	J2ROLLING_ANIMATION.init();	//ÊÇ·ñ¿ªÆô×Ô¶¯ÂÖ²¥
